...
| Component | Version  |
|:--------- | --------:|
| tor       | [0.4.9.4](https://forum.torproject.org/t/release-candidate-and-stable-release-0-4-8-22-and-0-4-9-4-rc/21160) |
...
```groovy
dependencies {
    implementation 'info.guardianproject:tor-android:0.4.9.4'
    implementation 'info.guardianproject:jtorctl:0.4.9.4'
}
```
