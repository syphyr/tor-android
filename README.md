...
| Component | Version  |
|:--------- | --------:|
| tor       | [0.4.8.20](https://forum.torproject.org/t/stable-release-0-4-8-20/) |
...
```gradle
dependencies {
    implementation 'info.guardianproject:tor-android:0.4.8.20'
    implementation 'info.guardianproject:jtorctl:0.4.8.20'
}
```
